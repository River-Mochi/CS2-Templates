...
//   * ProxyAction is the runtime handle to a Colossal input action (button/axis/vector).
//     It lets code read the current value (e.g., ReadValue<float>() or ReadValue<Vector2>())z  and subscribe to onInteraction events.
