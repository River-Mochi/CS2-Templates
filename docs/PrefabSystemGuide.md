...
| `PrefabRef` (instance link) | Instance component that points to the prefab entity (`m_Prefab`) | finding the prefab entity to edit | treating “prefab entity `*Data`” as baseline | `Game.Prefabs.PrefabRef.m_Prefab`<br>*(PrefabRef stores an entity handle in m_Prefab)* |
