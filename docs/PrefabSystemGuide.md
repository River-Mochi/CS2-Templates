...
|:---|:---|:----|:---|:---|
| `PrefabBase` authoring | Real prefab definition | true vanilla baseline / restore | writing runtime effects | `Game.Prefabs.DeathcareFacility.m_ProcessingRate`<br>`Game.Prefabs.DeathcareFacility.m_StorageCapacity`<br>`Game.Prefabs.Workplace.m_Workplaces`<br>`Game.Prefabs.Workplace.m_MinimumWorkersLimit` |
